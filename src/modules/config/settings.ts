...
export function getSettingGroups(): SettingGroup[] {
  return [
    ...
    },
    {
      ...
      title: 'Adsterra',
      description:
        'Banner + sticky placements. Disable the master switch to turn off every Adsterra unit at once',
      tab: 'ads',
    },
...
export function getSettings(): Setting[] {
  return [
    ...
    // ─── Ads / Adsterra ──────────────────────────────────────────────
    {
      ...
      title: 'Enable Adsterra',
      type: 'switch',
      tip: 'Master kill switch — off = no banners and no sticky anywhere',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      ...
      tip: 'Written to /ads.txt as: adsterra.com, {id}, DIRECT',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      name: 'adsterra_invoke_host',
      title: 'Invoke Host',
      type: 'text',
      placeholder: 'www.highperformanceformat.com',
      tip: 'Host from your banner invoke.js URL (no https://). Leave blank for the default',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      name: 'adsterra_below_game_key',
      title: 'Below-game Banner Key',
      type: 'text',
      placeholder: 'hex key from Adsterra',
      tip: 'Unique unit for the slot under #play on game pages (e.g. 728×90)',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      name: 'adsterra_below_game_width',
      title: 'Below-game Width',
      type: 'text',
      placeholder: '728',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_below_game_height',
      title: 'Below-game Height',
      type: 'text',
      placeholder: '90',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_content_top_key',
      title: 'Content-top Banner Key',
      type: 'text',
      placeholder: 'hex key from Adsterra',
      tip: 'Unique unit under article/guide titles — do not reuse other slot keys',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      name: 'adsterra_content_top_width',
      title: 'Content-top Width',
      type: 'text',
      placeholder: '728',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_content_top_height',
      title: 'Content-top Height',
      type: 'text',
      placeholder: '90',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_content_end_key',
      title: 'Content-end Banner Key',
      type: 'text',
      placeholder: 'hex key from Adsterra',
      tip: 'Unique unit at the end of articles/guides (e.g. 300×250)',
      group: 'adsterra',
      tab: 'ads',
    },
    {
      name: 'adsterra_content_end_width',
      title: 'Content-end Width',
      type: 'text',
      placeholder: '300',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_content_end_height',
      title: 'Content-end Height',
      type: 'text',
      placeholder: '250',
      group: 'adsterra',
      tab: 'ads',
    ...
    {
      name: 'adsterra_sticky_script_src',
      title: 'Sticky Script URL',
      type: 'text',
      placeholder: 'https://…/xx.js  or  //plXXXX.…/xx/xx/xx.js',
      tip: 'Sticky/social-bar script from Adsterra — only loads on blog/guide/MDX pages',
      group: 'adsterra',
      tab: 'ads',
    },
